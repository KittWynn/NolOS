/// 8x8 Bitmap Font Renderer — 32bpp true color version
...
pub fn draw_char(x: usize, y: usize, ch: u8, fg: u32, bg: u32) {
...
pub fn draw_str(x: usize, y: usize, s: &[u8], fg: u32, bg: u32) {
    for (i, &ch) in s.iter().enumerate() {
        draw_char(x + i * CHAR_W, y, ch, fg, bg);
    }
}
